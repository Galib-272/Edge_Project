        ...
        <div className="bg-neutral text-neutral-content">
            <footer className="footer p-10 container mx-auto">
                ...
                <div className="flex flex-col items-start space-y-4">
                    ...
                    <p className="text-lg font-semibold">
                        ...
                        <span className="text-sm font-light">
                            Providing reliable food and great experiences since 1992.
                        </span>
                    </p>
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    <p>
                        <strong>Email:</strong>{' '}
                        <a href="mailto:info@cafecentral.com" className="hover:text-yellow-400">
            ...
            <div className="text-center p-4 bg-neutral-focus text-neutral-content">
                © 2024 Cafe Central. All rights reserved.
            </div>
        </div>
    );
};
